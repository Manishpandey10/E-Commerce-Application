        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li
                        class="menu-item  {{ request()->routeIs(['personal.customer', 'business.customer']) ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ url('storage/' . Auth::user()->profileimage) }}"
                                        ...
                                        <a class="dropdown-item" href="{{ route('update-profile') }}">
                                            <div class="d-flex">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-0">Hello,{{ Auth::user()->username }} </h6>
