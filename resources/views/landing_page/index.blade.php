...
@section('main-container')
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="{{ url('landing_page/img/front_banner/banner-1.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <a href="{{ route('shop.page') }}" class="primary-btn">Shop now <span class="arrow_right"></span></a>
            ...
            <div class="hero__items set-bg" data-setbg="{{ url('landing_page/img/front_banner/banner-2.jpg') }}">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ url('storage/'.$data->productthumbnail) }}">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="{{ route('shop.details',$data->id) }}"><img src="{{ url('landing_page/img/icon/cart.png') }}" alt=""><span>Details</span></a></li>
                            </ul>
                        </div>
